...
INSERT INTO users (id, username, password, secret, first_name, last_name, email, phone, address, city, state, zip, country, date_created, enabled)
VALUES ('e18c8bcc-935d-444d-a194-3a32a3b35a49', 'admin', '$2a$10$YFhTnHpCL.Z0Ev0j1CbEUub7sIWmN7Qd5RmnU8g5ekuoapV7Zdx32', 'IJGK2F5OH6E4CD2NK6Q4BSREMGJSJXEC',
        'Admin', 'User', 'admin@localhost.com', '+44808123456', '', '', '', '', 'United Kingdom', CURDATE(), 1);
INSERT INTO users (id, username, password, secret, first_name, last_name, email, phone, address, city, state, zip, country, date_created, enabled)
VALUES ('32e7db01-86bc-4687-9ecb-d79b265ac14f', 'user1', '$2a$10$YFhTnHpCL.Z0Ev0j1CbEUub7sIWmN7Qd5RmnU8g5ekuoapV7Zdx32', 'IJGK2F5OH6E4CD2NK6Q4BSREMGJSJXEC',
        'Sam', 'Shopper', 'user1@localhost.com', '+44808123456', '1 Somewhere Street', 'London', 'Greater London', 'SW1', 'United Kingdom', CURDATE(), true);
...
VALUES ('db4cfab1-ff1d-4bca-a662-394771841383', 'user2', '$2a$10$YFhTnHpCL.Z0Ev0j1CbEUub7sIWmN7Qd5RmnU8g5ekuoapV7Zdx32', 'IJGK2F5OH6E4CD2NK6Q4BSREMGJSJXEC',
...
INSERT INTO users (id, username, password, secret, first_name, last_name, email, phone, address, city, state, zip, country, date_created, enabled)
VALUES ('92a82f45-7a03-42f3-80f8-ce4e9892409d', 'api', '$2a$10$YFhTnHpCL.Z0Ev0j1CbEUub7sIWmN7Qd5RmnU8g5ekuoapV7Zdx32', 'IJGK2F5OH6E4CD2NK6Q4BSREMGJSJXEC',
        'Api', 'User', 'api@localhost.com', '+44808123456', '1 Somewhere Street', 'London', 'Greater London', 'SW1', 'United Kingdom', CURDATE(), true);
INSERT INTO users (id, username, password, secret, first_name, last_name, email, phone, address, city, state, zip, country, date_created, enabled, verify_code)
VALUES ('3f91dc76-97fc-45d5-8db0-3bee04326a86', 'user4', '$2a$10$YFhTnHpCL.Z0Ev0j1CbEUub7sIWmN7Qd5RmnU8g5ekuoapV7Zdx32', 'IJGK2F5OH6E4CD2NK6Q4BSREMGJSJXEC',
...
VALUES ('ba802760-b33e-4352-acfa-0a10859b519a', 'SWA754-B418-00315', 'Alphadex Lite', 2,
        ...
        'Nam bibendum porta metus. Aliquam viverra pulvinar velit et condimentum. Pellentesque quis purus libero. Fusce hendrerit tortor sed nulla lobortis commodo. Donec ultrices mi et sollicitudin aliquam. Phasellus rhoncus commodo odio quis faucibus. Nullam interdum mi non egestas pellentesque. Duis nec porta leo, eu placerat tellus.',
        'generic-product-7.jpg', 9.95, true, 30, true);
INSERT INTO products (id, code, name, rating, summary, description, image, price, in_stock, time_to_stock, available)
VALUES ('339311c3-8325-464a-8ca6-4b78716f00d0', 'SWA432-E901-00126', 'Villacore 2000', true,
...
values ('6914e47d-2f0a-4deb-a712-12e7801e13e8', '32e7db01-86bc-4687-9ecb-d79b265ac14f',
        'Welcome to JWA. This is an example message that you can read', false);
INSERT INTO messages (id, user_id, text, read)
...
VALUES ('c9b31f33-17a4-4fcd-927e-c14cdee32201', '32e7db01-86bc-4687-9ecb-d79b265ac14f', CURDATE()-5, 'OID-P400-0001', 100.0, false,
        '[{"id":"6bbbeb10-6709-4163-a790-f691b09d6aca","name":"Dontax","price":8.50,"quantity":4}]');
INSERT INTO orders (id, user_id, order_date, order_num, amount, shipped, cart)
VALUES ('c94cbf6d-9baa-4a02-8eea-b13ceb43474d', '32e7db01-86bc-4687-9ecb-d79b265ac14f', CURDATE()-10, 'OID-P400-0001', 25.0, false,
...
VALUES ('81550b4f-c660-41ec-a6f3-076b611add9b', '32e7db01-86bc-4687-9ecb-d79b265ac14f', CURDATE()-20, 'OID-P401-0009', 50.0, true, CURDATE(),
        '[{"id":"6bbbeb10-6709-4163-a790-f691b09d6aca","name":"Dontax","price":8.50,"quantity":2}]');
INSERT INTO orders (id, user_id, order_date, order_num, amount, shipped, cart)
VALUES ('db4cfab1-ff1d-4bca-a662-394771841383', 'db4cfab1-ff1d-4bca-a662-394771841383', CURDATE()-10, 'OID-G320-0051', 25.0, false,
        '[{"id":"6bbbeb10-6709-4163-a790-f691b09d6aca","name":"Dontax","price":8.50,"quantity":1}]');
