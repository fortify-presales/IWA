...
create table authority (id integer not null, name varchar(255), primary key (id));
create table user (id integer generated by default as identity, date_created timestamp, password varchar(255), username varchar(255) not null, primary key (id));
